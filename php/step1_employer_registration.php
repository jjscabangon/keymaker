    ...
    if (empty($display_name) || empty($contact_no) || empty($email) || empty($username) || empty($password) || empty($confirm_pass)) {
        ...
        if ($stmt->execute()) {
            ...
            if ($stmt_profile->execute()) {
                ...
                header("Location: ../php/step2_employer_registration.php");
                exit();
            } else {
...
<head>
    ...
    <title>Employer Sign Up - Step 1</title>
    ...
    <div class="signup-container">
        <form action="" method="POST">
            ...
            <div class="user-details">
                <div class="input-box">
                    <label for="display-name">Business Name</label>
                    <input type="text" name="display_name" required />
                </div>
                <br>
             
                <div class="input-box full-width"> <!--go back for full width-->
